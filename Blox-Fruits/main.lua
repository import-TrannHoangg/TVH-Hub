...
GithubLogo.Size = UDim2.new(0, 35, 0, 35); GithubLogo.Position = UDim2.new(0.5, 0, 0.5, 0); GithubLogo.AnchorPoint = Vector2.new(0.5, 0.5)
GithubLogo.BackgroundTransparency = 1; GithubLogo.Image = "rbxassetid://107925154921311"; GithubLogo.ZIndex = 2
Instance.new("UIStroke", Icon).Color = Color3.fromRGB(0, 255, 255)

local MainGui = Instance.new("ScreenGui", guiParent)
MainGui.Name = "MainGui"; MainGui.Enabled = false; MainGui.ResetOnSpawn = false

Icon.MouseButton1Click:Connect(function() MainGui.Enabled = not MainGui.Enabled end)
...
createTab("Tab Cài Đặt", 6)MainGui.Enabled = false
